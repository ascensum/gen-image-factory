...
- `docs/architecture/testing-strategy.md` - Updated with pre-commit gate details, CI workflow documentation, centralized Semgrep configuration, and test-to-scenario mapping
