...
### File List
**New Files:**
- `.github/workflows/release.yml` - Automated release pipeline workflow (updated 2025-01-23: added `generate_release_notes: true`)
...
**Modified Files:**
- `package.json` - Added electron-builder, electron-updater, dist scripts, build configuration, publish configuration, release-notes scripts (2025-01-23)
...
- `.github/workflows/release.yml` - Updated to use GitHub native release notes generation (2025-01-23)
