...
- [ ] **Job Label Persistence**: Label editing in Single Job View not yet saving to database
- [ ] **Settings Edit Functionality**: Settings 'Edit' button not yet functional for job-specific modifications
- [ ] **Auto-save vs Manual Save**: Need to decide on label editing behavior (auto-save or save button)
