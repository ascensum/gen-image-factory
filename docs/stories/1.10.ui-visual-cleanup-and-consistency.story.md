...
### Additional Acceptance Criteria (added during implementation)

- Rerun labels render consistently across UI as `Parent Label (Rerun execIdShort)` in all states (including In Progress)
- Dropdown filters that behave as menus show a right‑aligned chevron indicator (Job Management Status uses the same affordance)
