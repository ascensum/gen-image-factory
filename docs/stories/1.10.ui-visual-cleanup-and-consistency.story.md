...
- Failed imeges review statistics, progress bars, indicators, filters improvements, badges, icons, labels, imterfaces
  -  [ ] Fix filters and search in 'Failed Image Review' page
  -  [x] Replace all emojis applied to single image card buttons in Failed Image Review page with .svg icons similar with those that are use in Main Dashboard Image Gallery Tab
  ...
  - [x] In 'QC Failed' badge on image card in grid view Failed Images Review emoji of triangle with exclamation mark shold be replacd wityh .svg icon in the style of those icons which are on Main Dashboard
  - [x] Replace 'Failed' text in the badge in Single Image Modal view in Failed Images Review to 'QC Failed' and emoji of triangle with exclamation mark shold be replacd wityh .svg icon in the style of those icons which are on Main Dashboard
  - [x] Move 'QC Failed' badge into the Single Image Review modal header to match Image Gallery placement
  - [x] Replace action button emojis (Approve/Retry/Delete) in review modal with unified SVG icons
  - [x] Move 'QC Failed' badge into Single Image Review modal header (match Image Gallery modal)
  - [x] Replace action emoji labels (Approve/Retry/Delete) with unified SVG icons in Single Image Review modal
...
### Completion Notes
- (to be filled upon completion of tasks)
